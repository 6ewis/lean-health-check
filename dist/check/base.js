...
module.exports = class Check {
  ...
  constructor(options) {
    ...
    this.technicalSummary = this.options.technicalSummary; // Set defaults
...
module.exports.requiredOptions = new Set(['businessImpact', 'id', 'interval', 'name', 'panicGuide', 'severity', 'technicalSummary']);
